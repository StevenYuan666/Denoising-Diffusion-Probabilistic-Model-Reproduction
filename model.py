...
class Denoiser(nn.Module):
    ...
    def __init__(self, image_resolution, hidden_dims=[256, 256], diffusion_time_embedding_dim=256, n_times=1000):
        ...
        self.time_embedding = PositionalEncoding(diffusion_time_embedding_dim)
...
if __name__ == "__main__":
    encoding = PositionalEncoding(20, 1000)
    # print(encoding(torch.tensor(1)))
    # print(encoding(torch.tensor(1)).shape)
    ...
    emb = SinusoidalPosEmb(20)
    t = torch.ones(size=(64,)).long()
    print(emb(t))
    print(emb(t).shape)
    print(encoding(t))
    print(encoding(t).shape)
